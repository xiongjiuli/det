...
class SwinTransformerSys3D(nn.Module):
    ...
    def __init__(self, pretrained=None,
        ...
        self._freeze_stages()
        self.channels = nn.Conv3d(3, 64, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x = self.forward_up_features(x, x_downsample, v_values_1, k_values_1, q_values_1, v_values_2, k_values_2,
                                     q_values_2)
        # print(f'the x shape before self.up_x4 is {x.shape}')
        x = self.up_x4(x)
        print(f'the x shape of self.up_x4 is {x.shape}')
        # x = self.channels(x)
        # print(f'after the channels the x shape is {x.shape}')
        #！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
...
if __name__ == '__main__':
    ...
    swin_unet = SwinTransformerSys3D(img_size=(128, 128, 128), num_classes=64)
    x1 = torch.randn(1, 1, 128, 128, 128)

    x2 = torch.randn(1, 1, 512, 512, 256)

    hmap, whd, offset = swin_unet(x1)
